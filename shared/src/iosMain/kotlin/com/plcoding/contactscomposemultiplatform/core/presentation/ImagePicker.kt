...
actual class ImagePicker(
    ...
    private val delegate = object : NSObject(), UIImagePickerControllerDelegateProtocol,
        ...
        override fun imagePickerController(
            ...
            // ImageNsData içerisindeki bytes değerini bytes dizisine kopyalıyoruz.
            // bytes.refTo(0) -> bytes dizisinin ilk elemanına referans veriyoruz.
            // imageNsData.bytes -> imageNsData içerisindeki bytes değerine referans veriyoruz.
